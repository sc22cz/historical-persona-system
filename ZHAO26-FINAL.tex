...
Development followed an iterative sprint structure documented through 47 Git commits over approximately six weeks, with the full commit history publicly available at \url{https://github.com/sc22cz/historical-persona-system}. Table~\ref{tab:sprints} summarises the sprint progression.
